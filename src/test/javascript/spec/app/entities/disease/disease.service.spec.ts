    ...
    describe('Disease Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/diseases';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Disease', () => {
                service.create(new Disease(null)).subscribe(received => {
            ...
            it('should update a Disease', () => {
                service.update(new Disease(123)).subscribe(received => {

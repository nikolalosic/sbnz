    ...
    describe('Ingredient Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/ingredients';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Ingredient', () => {
                service.create(new Ingredient(null)).subscribe(received => {
            ...
            it('should update a Ingredient', () => {
                service.update(new Ingredient(123)).subscribe(received => {

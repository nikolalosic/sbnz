    ...
    describe('Symptom Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/symptoms';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Symptom', () => {
                service.create(new Symptom(null)).subscribe(received => {
            ...
            it('should update a Symptom', () => {
                service.update(new Symptom(123)).subscribe(received => {

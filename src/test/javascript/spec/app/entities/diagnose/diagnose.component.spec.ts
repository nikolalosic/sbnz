...
import { DiagnoseComponent } from 'app/entities/diagnose/diagnose.component';
...
describe('Component Tests', () => {
    describe('Diagnose Management Component', () => {
        let comp: DiagnoseComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(DiagnoseComponent, '')
                .compileComponents();

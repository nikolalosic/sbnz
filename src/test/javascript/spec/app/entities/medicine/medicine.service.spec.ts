    ...
    describe('Medicine Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/medicines';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Medicine', () => {
                service.create(new Medicine(null)).subscribe(received => {
            ...
            it('should update a Medicine', () => {
                service.update(new Medicine(123)).subscribe(received => {

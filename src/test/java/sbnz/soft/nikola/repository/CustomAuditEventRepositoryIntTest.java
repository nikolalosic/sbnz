...
import sbnz.soft.nikola.config.audit.AuditEventConverter;
import sbnz.soft.nikola.domain.PersistentAuditEvent;
...
import static sbnz.soft.nikola.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;

...
import sbnz.soft.nikola.config.Constants;
import sbnz.soft.nikola.domain.Authority;
import sbnz.soft.nikola.domain.PersistentToken;
import sbnz.soft.nikola.domain.User;
import sbnz.soft.nikola.repository.AuthorityRepository;
import sbnz.soft.nikola.repository.PersistentTokenRepository;
import sbnz.soft.nikola.repository.UserRepository;
import sbnz.soft.nikola.security.AuthoritiesConstants;
import sbnz.soft.nikola.service.MailService;
import sbnz.soft.nikola.service.UserService;
import sbnz.soft.nikola.service.dto.PasswordChangeDTO;
import sbnz.soft.nikola.service.dto.UserDTO;
import sbnz.soft.nikola.web.rest.errors.ExceptionTranslator;
import sbnz.soft.nikola.web.rest.vm.KeyAndPasswordVM;
import sbnz.soft.nikola.web.rest.vm.ManagedUserVM;
...
public class AccountResourceIntTest {
    ...
    public void testRegisterValid() throws Exception {
        ...
        validUser.setAuthorities(Collections.singleton(AuthoritiesConstants.DOCTOR));
    ...
    public void testRegisterInvalidLogin() throws Exception {
        ...
        invalidUser.setAuthorities(Collections.singleton(AuthoritiesConstants.DOCTOR));
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        firstUser.setAuthorities(Collections.singleton(AuthoritiesConstants.DOCTOR));
    ...
    public void testRegisterAdminIsIgnored() throws Exception {
        ...
        assertThat(userDup.get().getAuthorities()).hasSize(1)
            .containsExactly(authorityRepository.findById(AuthoritiesConstants.DOCTOR).get());
    }

...
export class DiseaseComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.diseaseService
            ...
            .subscribe(
                (res: HttpResponse<IDisease[]>) => this.paginateDiseases(res.body, res.headers),
    ...
    trackId(index: number, item: IDisease) {
        return item.id;
    }
    ...
    private paginateDiseases(data: IDisease[], headers: HttpHeaders) {
